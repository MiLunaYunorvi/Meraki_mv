...
def snapshot_estatico(n,per):
    if n==0:
        res='static/img/caja2.jpg'
    else:
        res='static/img/cola_im/colai_{}.png'.format(per)
    return res
...
def bot(num):
    ...
    "text": '¡¡Se excedió el número de personas en la CAJA {}. ENVIEN REUERZOS!!'.format(num),
...
def estado_variable():
    ...
    global default
    default['caja'] = [cadena_caja,randint(0,1),2,randint(1,3),randint(2,3),randint(0,2)]
    default['cola'] = [cadena_cola,randint(0,4),5,randint(5,10),randint(4,8),randint(6,14)]
    return default
